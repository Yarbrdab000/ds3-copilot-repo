...
function baseActionsFeat() {
  return {
    ...
    system: {
      description: { value: "<p><strong>Strike</strong> \u2014 a weapon Attack (two at L5+).</p><p><strong>Dodge</strong> \u2014 always available, unlimited: flat d20 vs the move's Dodge DC, quality set by the window you call. Success negates damage and repositions 5 ft (end behind the foe \u2192 advantage next attack).</p><p><strong>Block</strong> \u2014 costs your reaction, no roll: a good shield negates physical (heavy hits force a Str save vs guard-break); a lesser/no shield halves and takes chip.</p><p><strong>Parry</strong> \u2014 costs your reaction: flat d20 vs the move's Parry DC; only the ideal window gives advantage, all others disadvantage. Success negates AND staggers (riposte window); failure takes full damage. See the Rules bible.</p>", chat: "" },
