...
function estus() {
  return {
    name: "Estus Flask", type: "consumable", img: "icons/consumables/potions/bottle-round-corked-orange.webp",
...
const WEAPONS = [
  ...
  weapon({ name: "Greataxe", img: "icons/weapons/axes/axe-double-engraved.webp", wtype: "martialM", baseItem: "greataxe", n: 1, d: 12, dtypes: [SL], props: ["hvy", "two"], scaleStat: "Strength", scaleAbil: "str", grade: "A", flavor: "A brutal cleaver that rewards commitment \u2014 and raw strength." }),
  ...
  weapon({ name: "Spear", img: "icons/weapons/polearms/spear-simple-hooked-grey.webp", wtype: "martialM", baseItem: "spear", n: 1, d: 6, dtypes: [PI], props: ["thr", "ver"], versatile: [1, 8], scaleStat: "Dexterity", scaleAbil: "dex", grade: "C", flavor: "Reach and a shield \u2014 the herald's discipline." }),
  weapon({ name: "Dagger", img: "icons/weapons/daggers/dagger-poisoned-curved-green.webp", wtype: "simpleM", baseItem: "dagger", n: 1, d: 4, dtypes: [PI], props: ["fin", "lgt", "thr"], scaleStat: "Dexterity", scaleAbil: "dex", grade: "A", flavor: "Quick, quiet, and lethal from the shadows \u2014 scales sharply with skill." }),
  weapon({ name: "Estoc", img: "icons/weapons/swords/sword-guard-flanged.webp", wtype: "martialM", baseItem: "rapier", n: 1, d: 8, dtypes: [PI], props: ["fin"], scaleStat: "Dexterity", scaleAbil: "dex", grade: "C", flavor: "A stiff thrusting sword that finds the gaps in armor." }),
  ...
  weapon({ name: "Shortbow", img: "icons/weapons/bows/shortbow-recurve.webp", wtype: "simpleR", baseItem: "shortbow", n: 1, d: 6, dtypes: [PI], props: ["amm", "two"], range: [80, 320], scaleStat: "Dexterity", scaleAbil: "dex", grade: "C", flavor: "A hunter's bow for keeping distance." })
];

const ARMOR = [
  armor({ name: "Knight's Plate", img: "icons/equipment/chest/breastplate-metal-scaled-grey.webp", atype: "heavy", ac: 18, dex: 0, strength: 15, stealth: true, damageReduction: 3, flavor: "Full steel — the Lothric ideal of defense." }),
  armor({ name: "Chainmail", img: "icons/equipment/chest/breastplate-collared-steel.webp", atype: "heavy", ac: 16, dex: 0, strength: 13, stealth: true, damageReduction: 2, flavor: "Interlocked rings, heavy but trusted." }),
  armor({ name: "Hard Leather Armor", img: "icons/equipment/chest/breastplate-layered-leather-brown.webp", atype: "light", ac: 11, dex: null, damageReduction: 1, flavor: "Boiled leather for those who'd rather move." }),
  armor({ name: "Knight Shield", img: "icons/equipment/shield/heater-steel-grey.webp", atype: "shield", ac: 2, flavor: "A solid steel shield — the heart of the Block reaction. It chips, it does not zero — a hard charge still gets a little through.", block: { physical: 0.70, fire: 0.40, lightning: 0.30, cold: 0.40, poison: 0.20 } }),
...
const UNIQUES = [
  ...
  weapon({ name: "Vordt's Great Hammer", img: "icons/weapons/maces/mace-cube-spiked-steel.webp", wtype: "martialM", baseItem: "maul", n: 2, d: 6, dtypes: [BL], props: ["hvy", "two"], scaleStat: "Strength", scaleAbil: "str", grade: "A", upgrade: 1, rarity: "rare",
  ...
  weapon({ name: "Uchigatana", img: "icons/weapons/swords/sword-katana.webp", wtype: "martialM", baseItem: "longsword", n: 1, d: 8, dtypes: [SL], props: ["fin", "ver"], versatile: [1, 10], scaleStat: "Dexterity", scaleAbil: "dex", grade: "A", rarity: "uncommon",
  ...
  armor({ name: "Lothric Knight Greatshield", img: "icons/equipment/shield/heater-embossed-gold.webp", atype: "shield", ac: 2, rarity: "rare",
...
const EXTRA_WEAPONS = [
  ...
  weapon({ name: "Broadsword", img: "icons/weapons/swords/sword-guard-brass-worn.webp", wtype: "martialM", baseItem: "longsword", n: 1, d: 8, dtypes: [SL], props: ["ver"], versatile: [1, 10], scaleStat: "Strength", scaleAbil: "str", grade: "C", flavor: "A wide straight blade; wider arc, same reliable cut." }),
  ...
  weapon({ name: "Sunlight Straight Sword", img: "icons/weapons/swords/sword-guard-worn-gold.webp", wtype: "martialM", baseItem: "longsword", n: 1, d: 8, dtypes: [SL], props: ["ver"], versatile: [1, 10], scaleStat: "Strength", scaleAbil: "str", grade: "C", rarity: "uncommon", flavor: "Praise the sun. A warm, dependable blade of cooperation." }),
  ...
  weapon({ name: "Bastard Sword", img: "icons/weapons/swords/greatsword-crossguard-blue.webp", wtype: "martialM", baseItem: "greatsword", n: 2, d: 6, dtypes: [SL], props: ["hvy", "two"], scaleStat: "Strength", scaleAbil: "str", grade: "B", flavor: "A blunt, brutal greatsword for raw strength." }),
  weapon({ name: "Wolnir's Holy Sword", img: "icons/weapons/swords/greatsword-blue.webp", wtype: "martialM", baseItem: "greatsword", n: 2, d: 6, dtypes: [SL], props: ["hvy", "two"], scaleStat: "Faith", scaleAbil: "wis", grade: "B", rarity: "uncommon", flavor: "A holy greatsword that drinks the dark; scales with faith." }),
  // Ultra greatswords (STR A, 2d8 hvy two)
  weapon({ name: "Zweihander", img: "icons/weapons/swords/greatsword-guard.webp", wtype: "martialM", baseItem: "greatsword", n: 2, d: 8, dtypes: [SL], props: ["hvy", "two"], scaleStat: "Strength", scaleAbil: "str", grade: "A", rarity: "uncommon", flavor: "A massive flat blade; commit or be crushed." }),
  ...
  weapon({ name: "Black Blade", img: "icons/weapons/swords/sword-katana-purple.webp", wtype: "martialM", baseItem: "longsword", n: 1, d: 8, dtypes: [SL], props: ["fin", "ver"], versatile: [1, 10], scaleStat: "Dexterity", scaleAbil: "dex", grade: "A", rarity: "uncommon", flavor: "A shortened soul-blade; quick and deadly." }),
  ...
  weapon({ name: "Ricard's Rapier", img: "icons/weapons/swords/sword-guard-worn-gold.webp", wtype: "martialM", baseItem: "rapier", n: 1, d: 8, dtypes: [PI], props: ["fin"], scaleStat: "Dexterity", scaleAbil: "dex", grade: "A", rarity: "uncommon", flavor: "An ornate rapier; flurries of precise thrusts." }),
  ...
  weapon({ name: "Dragonslayer Greataxe", img: "icons/weapons/axes/axe-double-engraved.webp", wtype: "martialM", baseItem: "greataxe", n: 1, d: 12, dtypes: [SL], props: ["hvy", "two"], scaleStat: "Strength", scaleAbil: "str", grade: "A", rarity: "uncommon", flavor: "A storm-charged greataxe; crushes guards." }),
  ...
  weapon({ name: "Reinforced Club", img: "icons/weapons/clubs/club-banded-brown.webp", wtype: "simpleM", baseItem: "club", n: 1, d: 6, dtypes: [BL], props: ["lgt"], scaleStat: "Strength", scaleAbil: "str", grade: "C", flavor: "A club studded with iron; the Deprived's upgrade." }),
  weapon({ name: "Morning Star", img: "icons/weapons/maces/mace-spiked-steel-grey.webp", wtype: "martialM", baseItem: "morningstar", n: 1, d: 8, dtypes: [PI], scaleStat: "Strength", scaleAbil: "str", grade: "C", flavor: "Spiked head; bleeds and bludgeons." }),
  ...
  weapon({ name: "Large Club", img: "icons/weapons/clubs/club-heavy-barbed-brown.webp", wtype: "martialM", baseItem: "maul", n: 2, d: 6, dtypes: [BL], props: ["hvy", "two"], scaleStat: "Strength", scaleAbil: "str", grade: "A", flavor: "A massive tree-trunk club; slow, devastating." }),
  ...
  weapon({ name: "Winged Spear", img: "icons/weapons/polearms/spear-simple-barbed.webp", wtype: "martialM", baseItem: "spear", n: 1, d: 6, dtypes: [PI], props: ["thr", "rch", "ver"], versatile: [1, 8], scaleStat: "Dexterity", scaleAbil: "dex", grade: "C", flavor: "A long reach spear; keep them at bay." }),
  ...
  // Daggers / fists
  weapon({ name: "Bandit's Knife", img: "icons/weapons/daggers/dagger-poisoned-curved-green.webp", wtype: "simpleM", baseItem: "dagger", n: 1, d: 4, dtypes: [SL], props: ["fin", "lgt", "thr"], scaleStat: "Dexterity", scaleAbil: "dex", grade: "A", flavor: "A bleeding gut-hook knife for backstabs." }),
  weapon({ name: "Caestus", img: "icons/weapons/fist/fist-knuckles-spiked-brown.webp", wtype: "simpleM", baseItem: "club", n: 1, d: 4, dtypes: [BL], props: ["lgt"], scaleStat: "Strength", scaleAbil: "str", grade: "D", flavor: "Iron knuckles; a parry tool in a pinch." }),
  // Bows / crossbows
  ...
  weapon({ name: "Heavy Crossbow", img: "icons/weapons/crossbows/crossbow-heavy.webp", wtype: "martialR", baseItem: "heavycrossbow", n: 1, d: 10, dtypes: [PI], props: ["amm", "lod", "two", "hvy"], range: [100, 400], scaleStat: "Strength", scaleAbil: "str", grade: "D", flavor: "Punishing bolts; slow to crank." }),
...
const EXTRA_FOCI = [
  focus({ name: "Heretic's Staff", img: "icons/weapons/staves/staff-animal-skull.webp", schoolText: "channels Sorceries (Intelligence).", scaleStat: "Intelligence", grade: "S", rarity: "uncommon", flavor: "A fragile staff of pure raw power; high scaling, no upgrades." }),
  ...
  focus({ name: "Great Swamp Pyromancy Flame", img: "icons/magic/fire/flame-burning-fist-strike.webp", schoolText: "channels Pyromancies (Int/Faith).", scaleStat: "Int/Faith", grade: "A", rarity: "uncommon", flavor: "A fiercer flame from the Great Swamp; burns hotter." })
];
...
const EXTRA_SHIELDS = [
  ...
  armor({ name: "Black Knight Shield", img: "icons/equipment/shield/heater-crystal-blue.webp", atype: "shield", ac: 2, rarity: "uncommon", flavor: "Charred shield of the Black Knights; eats fire for breakfast.", block: { physical: 0.90, fire: 0.95, lightning: 0.30, cold: 0.50, poison: 0.30 } }),
  armor({ name: "Dragon Crest Shield", img: "icons/equipment/shield/round-wooden-boss-gold-brown.webp", atype: "shield", ac: 2, rarity: "uncommon", flavor: "A dragon-marked shield; flame washes off it.", block: { physical: 0.75, fire: 1.00, lightning: 0.50, cold: 0.45, poison: 0.30 } }),
  armor({ name: "Silver Knight Shield", img: "icons/equipment/shield/round-wooden-reinforced-boss-steel.webp", atype: "shield", ac: 2, rarity: "uncommon", flavor: "Anor Londo silver; turns aside lightning and steel.", block: { physical: 1.00, fire: 0.50, lightning: 0.70, cold: 0.50, poison: 0.30 } }),
  armor({ name: "Spider Shield", img: "icons/equipment/shield/round-wooden-boss-steel-brown.webp", atype: "shield", ac: 2, flavor: "A crude shield warded against venom.", block: { physical: 0.70, fire: 0.30, lightning: 0.30, cold: 0.30, poison: 0.95 } }),
  armor({ name: "Grass Crest Shield", img: "icons/equipment/shield/heater-emossed-spiral-green.webp", atype: "shield", ac: 2, flavor: "Light shield famed for stamina — a parry-leaning small shield.", block: { physical: 0.65, fire: 0.30, lightning: 0.40, cold: 0.30, poison: 0.20 } }),
  armor({ name: "Frost-Ward Shield", img: "icons/equipment/shield/kite-wooden-boss-steel-blue.webp", atype: "shield", ac: 2, rarity: "uncommon", flavor: "Boreal-forged; the cold cannot pass it.", block: { physical: 0.80, fire: 0.40, lightning: 0.40, cold: 1.00, poison: 0.30 } })
];
...
async function main() {
  ...
  const all = [
    ...
    loot({ name: "Estus Shard", img: "icons/commodities/gems/gem-faceted-trillion-orange.webp", subtype: "material", price: 1000, flavor: "A shard of an Estus Flask; the Fire Keeper can use it to add a charge." }),
