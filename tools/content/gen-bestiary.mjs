...
function attack({ name, img, n, d, bonus, types, ability = "str", reach = 5, ranged = false, range = null, def = null }) {
  return {
    name, type: "weapon", img: img || "icons/skills/melee/strike-slashes-orange.webp", effects: [], flags: def ? { ashen: { def } } : {},
    system: {
...
const ACTORS = [
  ...
  npc({ name: "Hollow Assassin", img: "icons/creatures/magical/spirit-undead-ghost-purple.webp", ac: 13, hp: 12, hpFormula: "3d8-1", cr: 0.5, souls: 60, role: "ranged", str: 9, dex: 15, con: 10,
    ...
    attacks: [attack({ name: "Snap Shot", n: 1, d: 8, bonus: 3, types: [PI], ability: "dex", ranged: true, range: [80, 320], def: { dc: 12, dw: "W2", np: true } })] }),
  ...
  npc({ name: "Starving Hound", img: "icons/creatures/abilities/wolf-howl-moon-purple.webp", ac: 13, hp: 9, hpFormula: "2d6+2", cr: 0.25, souls: 40, role: "fast-pack", ctype: "beast", str: 12, dex: 15, con: 12,
    ...
    attacks: [attack({ name: "Pounce", n: 1, d: 6, bonus: 2, types: [PI], ability: "dex", def: { dc: 12, dw: "W2", np: true } })] }),
  ...
  npc({ name: "Iudex Gundyr", img: "modules/ashen-of-lothric/tokens/iudex-gundyr.png", ac: 16, ...bossHP(3.4, "act1"), cr: 5, souls: 2500, role: "major-boss", size: "lg", legact: 2,
    ...
    attacks: [
      attack({ name: "Overhead Chop", n: 2, d: 10, bonus: 4, types: [SL], reach: 10, def: { dc: 14, dw: "W2", pw: "W3" } }),
      attack({ name: "Wide Sweep", n: 2, d: 10, bonus: 4, types: [SL], reach: 10, def: { dc: 14, dw: "W2", np: true } }),
      attack({ name: "Thrust Lunge", n: 2, d: 10, bonus: 4, types: [PI], reach: 10, def: { dc: 14, dw: "W2", pw: "W2" } }),
      attack({ name: "Shield Kick", n: 1, d: 8, bonus: 4, types: [BL], reach: 5, def: { dc: 14, dw: "W2", np: true, nb: true } })
    ] }),
  npc({ name: "Pus of Man (Gundyr Eruption)", img: "modules/ashen-of-lothric/tokens/pus-of-man-gundyr.png", ac: 15, ...bossHP(3, "act1"), cr: 5, souls: 0, role: "major-boss-p2", size: "lg", reach: 15,
    ...
    attacks: [
      attack({ name: "Tendril Multi-lash", n: 2, d: 8, bonus: 4, types: [BL], reach: 15, def: { dc: 14, dw: "W2", np: true } }),
      attack({ name: "Grab", n: 1, d: 10, bonus: 4, types: [BL], reach: 15, def: { dc: 14, dw: "W1", np: true, nb: true } }),
      attack({ name: "Ground Slam", n: 3, d: 8, bonus: 0, types: [BL], reach: 10, def: { dc: 14, dw: "W1", np: true } })
    ] }),
  npc({ name: "Outrider Knight", img: "modules/ashen-of-lothric/tokens/outrider-knight.png", ac: 17, ...bossHP(4, "mini"), cr: 4, souls: 1000, role: "mini-boss", size: "med", walk: 40,
    ...
    attacks: [
      attack({ name: "Triple Claw Combo", n: 1, d: 8, bonus: 3, types: [SL], ability: "dex", reach: 5, def: { dc: 13, dw: "W2", pw: "W3" } }),
      attack({ name: "Frost Lunge", n: 2, d: 8, bonus: 3, types: [SL], ability: "dex", reach: 40, def: { dc: 13, dw: "W1", nb: true, np: true } }),
      attack({ name: "Pounce", n: 2, d: 10, bonus: 3, types: [BL], reach: 5, def: { dc: 13, dw: "W2", np: true } })
    ] }),
  npc({ name: "Pus of Man (High Wall)", img: "modules/ashen-of-lothric/tokens/pus-of-man-gundyr.png", ac: 14, ...bossHP(4, "mini"), cr: 4, souls: 1000, role: "mini-boss", size: "lg", reach: 15,
    ...
    attacks: [
      attack({ name: "Whipping Tendrils", n: 2, d: 6, bonus: 3, types: [BL], reach: 15, def: { dc: 13, dw: "W2", np: true } }),
      attack({ name: "Lunge Bite", n: 2, d: 8, bonus: 3, types: [PI], reach: 15, def: { dc: 13, dw: "W2", pw: "W2" } }),
      attack({ name: "Black Spew", n: 3, d: 6, bonus: 0, types: ["poison"], reach: 15, def: { dc: 13, dw: "W1", np: true } })
    ] }),
  npc({ name: "The Dragon", img: "modules/ashen-of-lothric/tokens/the-dragon.png", ac: 18, ...bossHP(5.5, "dragon"), cr: 8, souls: 4000, role: "secret-boss", size: "huge", walk: 40, fly: 80,
    ...
    attacks: [
      attack({ name: "Fire Breath (4d8, Dex save)", n: 4, d: 8, bonus: 0, types: [FIRE], ranged: true, range: [60, 60], def: { dc: 15, nd: true, nb: true, np: true } }),
      attack({ name: "Claw", n: 3, d: 8, bonus: 5, types: [SL], reach: 10, def: { dc: 15, dw: "W2", np: true } }),
      attack({ name: "Tail Sweep", n: 3, d: 10, bonus: 5, types: [BL], reach: 10, def: { dc: 15, dw: "W2", np: true } })
    ] }),
  npc({ name: "Vordt of the Boreal Valley", img: "modules/ashen-of-lothric/tokens/vordt.png", ac: 18, ...bossHP(6, "vordt"), cr: 6, souls: 3000, role: "major-boss", size: "lg", walk: 40, legact: 3,
    ...
    attacks: [
      attack({ name: "Overhead Mace Smash", n: 2, d: 8, bonus: 5, types: [BL], reach: 10, def: { dc: 15, dw: "W2", pw: "W3" } }),
      attack({ name: "Wide Sweep", n: 2, d: 8, bonus: 5, types: [BL], reach: 10, def: { dc: 15, dw: "W2", np: true } }),
      attack({ name: "Frost Charge", n: 3, d: 8, bonus: 5, types: [BL], reach: 10, def: { dc: 15, dw: "W1", nb: true, np: true } }),
      attack({ name: "Frostbreath Cone", n: 3, d: 8, bonus: 0, types: ["cold"], reach: 20, def: { dc: 15, dw: "W1", np: true } }),
      attack({ name: "Grab-Leap", n: 3, d: 10, bonus: 5, types: [BL], reach: 10, def: { dc: 15, dw: "W1", nb: true, np: true } })
    ] }),
  ...
  npc({ name: "Sword Master", img: "icons/weapons/swords/sword-katana.webp", ac: 16, hp: 60, hpFormula: "8d8+24", cr: 4, souls: 800, role: "duel-npc-and-mercy-valve", disposition: 0, walk: 35,
    ...
    attacks: [
      attack({ name: "Iaido Double-Slash", n: 2, d: 8, bonus: 4, types: [SL], ability: "dex", def: { dc: 13, dw: "W2", pw: "W3" } }),
      attack({ name: "Step Thrust", n: 1, d: 10, bonus: 4, types: [SL], ability: "dex", reach: 10, def: { dc: 13, dw: "W1", pw: "W2" } }),
      attack({ name: "Uchigatana", n: 1, d: 8, bonus: 4, types: [SL], ability: "dex", def: { dc: 13, dw: "W2", pw: "W2" } })
    ] })
];
